<template>
    <div>
        ...
        <h5>Category 1 — Strictly Necessary Cookies</h5>
        ...
        <h5>Category 2 — Performance Cookies</h5>
        ...
        <h5>Category 3 — Functionality Cookies</h5>
